...
public interface OffreRepository extends JpaRepository<Offre, Long> {
     ...
     */
    Page<Offre> findByLibelleContainingIgnoreCase(String libelle, Pageable pageable);
     ...
     * @return une page des abonnés
     */
    Page<Offre> findByDescriptionContainingIgnoreCase(String description, Pageable pageable);
}
